      ...
      <div className="p-2 border-t border-slate-200 shrink-0 bg-white">
        <button
          ...
          className={
            ...
            'shadow-sm flex items-center justify-center gap-1.5 transition-colors ' +
            (
              dock.currentTruck &&
              !isOperationBusy
            ...
            <div className="bg-white rounded-xl shadow-xl w-full max-w-sm max-h-[92vh] overflow-y-auto border border-slate-200">
              ...
              <div className="p-5 space-y-4">
                ...
                <button
                  ...
                  className={
                    'w-full border-2 font-bold py-3 rounded-lg transition-colors ' +
            ...
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-md overflow-hidden border border-slate-200">
              <div className="bg-amber-500 p-4 flex justify-between items-center text-slate-900">
                ...
                <button
                  ...
                  className="hover:bg-amber-600 p-2 rounded-lg transition-colors"
                  aria-label="ปิดหน้าต่างโยกช่อง"
                >
                  <X
                    size={22}
                  />
              ...
              <div className="p-5">
                ...
                <button
                  ...
                  className="w-full mt-4 py-3 rounded-lg border border-slate-300 text-slate-600 font-bold hover:bg-slate-50 transition-colors"
                >
                  ยกเลิก
                </button>
              </div>
