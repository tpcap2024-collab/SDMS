...
import { AlertCircle, CheckCircle2, Phone, PlayCircle, X } from 'lucide-react';
          ...
          >
            ...
            <div className="mt-auto pt-2">
              <div className="w-full bg-slate-100 h-2 rounded-full overflow-hidden">
                <div
                  className={(dock.status === 'delayed' ? 'bg-rose-500' : 'bg-amber-500') + ' h-full transition-all duration-500'}
                  ...
                  {calledTrucks[selectedTruck.id] ? (
                    <>
                      <button
                        ...
                        className="w-full bg-rose-500 border-2 border-rose-500 text-white font-bold py-3 rounded-lg hover:bg-rose-600 transition-colors shadow-sm"
                      >
                        ยกเลิกยืนยันโทร
                      </button>
                      <button
                        ...
                        className="w-full bg-blue-600 border-2 border-blue-600 text-white font-bold py-3 rounded-lg hover:bg-blue-700 transition-colors shadow-sm flex items-center justify-center gap-1.5"
                      >
                        <PlayCircle size={18} />
                        เข้าช่อง
                      </button>
                    ...
                    <>
                      ...
                      <button
                        ...
                        className="w-full bg-blue-600 border-2 border-blue-600 text-white font-bold py-3 rounded-lg hover:bg-blue-700 transition-colors shadow-sm"
                      >
                        ยืนยันโทรเรียกแล้ว
                      </button>
                    </>
