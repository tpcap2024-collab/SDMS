          ...
          {dock
            ...
            >
              ...
              <div className="mt-auto pt-2">
                ...
                <p className="text-right text-[10px] font-bold mt-1 text-amber-600">
                  {
                    dock
                      .currentTruck
                      .progress
                  ...
                  {calledTrucks[
                    ...
                    <>
                      {selectedPhoneLink ? (
                        ...
                        <button
                          disabled
                          className="bg-slate-100 border-2 border-slate-200 text-slate-400 font-bold py-3 rounded-lg"
                        >
                          ไม่มีเบอร์โทร
                        </button>
                      )}
