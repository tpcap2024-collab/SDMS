        ...
        if (
          ...
          return res
            ...
            .json({
              success: false,
              error:
                "sourceDock and targetDock must be different",
            });
        }
